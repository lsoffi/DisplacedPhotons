...
my_id_modules = ['RecoEgamma.ElectronIdentification.Identification.cutBasedElectronID_VID_Tutorial_2017_cff',
...
process.ntupler = cms.EDAnalyzer(
    ...
    #
#      eleIdMap = cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-VID-Tutorial-2017-Test-NewVars"),
    eleIdMap = cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-VID-Tutorial-2017-Test"),
